...
router.addRoute(['GET', 'HEAD'], '/api/v1/countries', async (req: any, res: any) => {
  return { yey: 'GET countries' };
});

router.addRoute(['GET', 'HEAD'], '/api/v1/regions', async (req: any, res: any) => {
...
*/
router.addRoute(['GET', 'HEAD'], '/api/v1/time', async (req: Request, res: Response) => {
...
router
  .addRoute(['GET', 'HEAD'], '/api/v1/part2/:param1', async (req: Request, res: Response) => {
    return { yey: 'GET part2', param1: req.params.param1 };
  })
  .addMiddleware(logResponseMiddleware);

router.addRoute(['GET', 'HEAD'], '/api/v1/test', async (req: Request, res: Response) => {
