...
export async function loggerMiddleware(req: Request, res: Response, next: () => Promise<void>): Promise<void> {
  logger().info({
...
export async function logResponseMiddleware(req: Request, res: Response, next: () => Promise<void>): Promise<void> {
  await next();
  logger().info({ msg: 'response:', statusCode: res.statusCode });
}

export async function authenticate(req: Request, res: Response, next: () => Promise<void>): Promise<void> {
