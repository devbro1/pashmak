...
export class SelectQueryBuilder {
  ...
  public select(selects: string | any[] | RawSQL) {
    if (typeof selects === 'string') {
      ...
      const matches = selects.match(/"?(?<alias>[a-zA-Z0-9]*)"?\."?(?<var_name>.*)"?/);
      if (matches) {
        selects2 = {
  ...
  public table(table: string | RawSQL) {
    ...
    } else if (typeof table === 'object' && table.constructor.name === 'RawSQL') {
  ...
  public where(column: string | any[] | RawSQL, operation: operation = '=', value: any = '') {
    ...
    } else if (typeof column == 'object' && column.constructor.name === 'RawSQL') {
  ...
  public whereNot(column: string | any[] | RawSQL, operation: operation = '=', value: any = '') {
    if (typeof column == 'string') {
  ...
  public orWhere(column: string | any[], operation: operation = '=', value: any = '') {
    if (typeof column == 'string') {
