...
export type operation = '=' | '!=' | '>' | '<' | '>=' | '<=' | 'IN' | 'BETWEEN' | 'ILIKE' | 'LIKE';
type node = {
  column_name: string;
  operation: operation;
...
export class ConditionClause {
  ...
  constructor(client: any) {
    ...
    ['Column', 'Raw', 'ConditionClause', 'Exists', 'Null', 'Date'].forEach((method) => {
      // @ts-ignore
      this['or' + method] = (...args: any) => {
        this['and' + method](...args, { join_condition: 'OR' });
      };
      // @ts-ignore
      this['and' + method + 'Not'] = (...args: any) => {
        this['and' + method](...args, { join_condition: 'AND NOT' });
      };
      // @ts-ignore
      this['or' + method + 'Not'] = (...args: any) => {
        this['and' + method](...args, { join_condition: 'OR NOT' });
      };
    });
  }
  ...
  public orColumn = (column: string, operation: operation, value: any, options: options = {}) =>
    this;
  public orColumnNot = (column: string, operation: operation, value: any, options: options = {}) =>
    this;
  public andColumnNot = (column: string, operation: operation, value: any, options: options = {}) =>
    this;
  ...
  public andConditionClause(cc: ConditionClause, options: options = {}) {
    return this.and('', '=', '', {
      ...{ condition_clause: cc, type: 'CONDITION_CLAUSE' },
      ...options,
    });
  }
  ...
  public orDateNot = (column: string, operation: operation, date: Date, options: options = {}) =>
    this;
  public andDateNot = (column: string, operation: operation, date: Date, options: options = {}) =>
    this;
  public andDate(column: string, operation: operation, date: Date, options: options = {}) {
    return this.and(column, operation, date, {
      ...{ column_name: column, type: 'DATE_COMPARE' },
      ...options,
    });
  }
